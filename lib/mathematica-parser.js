...
export default class MathematicaParser {
  ...
  updateTokens(change) {
    ...
    var changedRegion = this.parser.bufferChangedSync(bufferText, startIndex, length, change.newText)
  ...
  populateTokens() {
    //console.log("populateTokens start");
    //locs = java.callMethodSync(this.parser, "getLocalVariables")
    this.tokens = java.callMethodSync(this.parser, "getTokens")
    //this.scopedVariableIndices = locs.map(function(variable){return variable.fVariable.getCharEndSync()})
    //console.log("populateTokens end");
  }
